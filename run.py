...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", default= sys.path[0]+'/../outputs', type=str, 
    ...
    parser.add_argument('--tmp_k', type=float, default=0.8, help="random k for sup_dis_loss")
